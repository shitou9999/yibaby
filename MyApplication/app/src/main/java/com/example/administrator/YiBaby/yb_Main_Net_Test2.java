...
public class yb_Main_Net_Test2 extends AppCompatActivity
    ...
    private BBS_resultObject bbs_resultObj1;
    private BBS_resultObject bbs_resultObj2;
        ...
        MyStringRequest request=new MyStringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                for(ResultObject img:resultObjects){
                    imageView=new ImageView(yb_Main_Net_Test2.this);
            ...
            public void onPageScrollStateChanged(int state) {
                switch (state) {
                    ...
                    case 0:// 滑动结束
                        ...
                        if (pagerVip.getCurrentItem() == pagerVip.getAdapter().getCount() - 1 && !isScrolled) {
                            pagerVip.setCurrentItem(0,false);
                        }// 当前为第一张，此时从左向右滑，则切换到最后一张
                        else if (pagerVip.getCurrentItem() == 0 && !isScrolled) {
                            pagerVip.setCurrentItem(pagerVip.getAdapter().getCount() - 1,false);
                        }
                        break;
                    default:
                        break;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    ...
                    Intent intent1 = new Intent(yb_Main_Net_Test2.this, yb_SeeComment_Activity.class);
                    intent1.putExtra("bbs_resultObj", bbs_resultObj1);
                    startActivity(intent1);
                    break;
                case 1:
                    BBS_resultObject bbs_resultObj2= (BBS_resultObject) msg.obj;
                    Intent intent2 = new Intent(yb_Main_Net_Test2.this, yb_SeeComment_Activity.class);
    ...
    private void initViewListener(){
        zxing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(yb_Main_Net_Test2.this, BarCodeTestActivity.class);
        ...
        rl01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(yb_Main_Net_Test2.this,yb_Mood.class);
                startActivity(intent);
            }
        });
        rlGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(yb_Main_Net_Test2.this,yb_Go_Milk_Fg_Ms.class);
                startActivity(intent);
            }
        });
        rlMum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(yb_Main_Net_Test2.this, yb_Mum_Circle.class);
                startActivity(intent);
            }
        });
        rlIam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(yb_Main_Net_Test2.this, yb_Login_Activity.class);
                startActivity(intent);
            }
        });
            ...
            public void onClick(View v) {
                ...
                MyStringRequest request = new MyStringRequest(url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        bbs_resultObj1 = gson.fromJson(h_commentW.getResultObject(),BBS_resultObject.class);
            ...
            public void onClick(View v) {
                ...
                MyStringRequest request = new MyStringRequest(url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Gson gson = new Gson();
                        H_CommentW h_commentW = gson.fromJson(response, H_CommentW.class);
                        bbs_resultObj2 = gson.fromJson(h_commentW.getResultObject(),BBS_resultObject.class);
                        Message message=new Message();
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(yb_Main_Net_Test2.this, yb_BBS_FragmentManager.class);
                startActivity(intent);
            }
        });
    }
...
//        Intent intent=new Intent(this,yb_ImageDetilActivity.class);
//        startActivity(intent);
//    }
