...
public class yb_Main_Net extends AppCompatActivity
    ...
    public void callBackMainCommentNet(List list) {
        ...
        List<resourceList> ybComment3s= ybComment2y.getResourceList();
        if(ybComment3s.size()==0){
            baby1.setVisibility(View.GONE);
        }else{
            app.getImageLoader().get(ybComment3s.get(0).getImgSmall(),
                    ImageLoader.getImageListener(baby1, 0, 0));
        }
        //评论2
        ybComment22=ybComment2List.get(0);
        List<resourceList> ybComment3ss= ybComment22.getResourceList();
        ...
        if(ybComment3ss.size()==0){
            ...
            app.getImageLoader().get(ybComment3ss.get(0).getImgSmall(),
        ...
        MyStringRequest request=new MyStringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                for(ResultObject img:resultObjects){
                    imageView=new ImageView(yb_Main_Net.this);
    ...
    private void initViewListener(){
        zxing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(yb_Main_Net.this, BarCodeTestActivity.class);
        ...
        rl01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(yb_Main_Net.this,yb_Mood.class);
                startActivity(intent);
            }
        });
        rlGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(yb_Main_Net.this,yb_Go_Milk_Fg_Ms.class);
                startActivity(intent);
            }
        });
        rlMum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(yb_Main_Net.this, yb_Mum_Circle.class);
                startActivity(intent);
            }
        });
        rlIam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(yb_Main_Net.this, yb_Login_Activity.class);
                startActivity(intent);
            }
        });
        seeComment1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(yb_Main_Net.this,yb_Comment_Detil.class);
...
//                intent.putExtras(bundle);
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(yb_Main_Net.this, yb_BBS_FragmentManager.class);
                startActivity(intent);
            }
        });
    }
    private void initFindViewById(){
        ...
        baby1= (ImageView) super.findViewById(R.id.baby1);
